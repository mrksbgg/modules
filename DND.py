...
class DoNotDisturbMod(loader.Module):
    ...
    strings = {
        ...
        "afk_no_pm_off": "<b><emoji document_id=5979027086612892618>📍</emoji> AFK статус был включен в личных сообщениях.</b>",
        "afk_no_pm_on": "<b><emoji document_id=5976553640716930004>📍</emoji> AFK статус был отключен в личных сообщениях.</b>",
        ...
        "pm_off": (
            "<b>Автоматический ответ на отклоненное личное сообщение отключен."
            "\n\nПользователи теперь могут свободно писать в личные сообщения!</b>"
        ),
        ...
        "pm_reported": "<b><emoji document_id=5465432711218863135>♨️</emoji>Вы получили предупреждение за спам!</b>",
        "pm_limit_arg": "<b>Аргумент должен быть 'off', 'on' или любое число от 5 до 1000!</b>",
        ...
        "pm_limit_current_no": "<b>Автоматическая блокировка пользователей отключена.</b>",
