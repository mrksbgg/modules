...
class DoNotDisturbMod(loader.Module):
    ...
    strings = {
        ...
        "afk_no_pm_off": "<b><emoji document_id=5979027086612892618>📍</emoji> AFK status message enabled for PMs.</b>",
        "afk_no_pm_on": "<b><emoji document_id=5976553640716930004>📍</emoji> AFK status message disabled for PMs.</b>",
